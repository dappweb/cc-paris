...
const HistoryTimeline: React.FC = () => {
  return (
    <section id="history" className="py-32 bg-brand-black relative">
      <div className="container mx-auto px-6">
        ...
        <div className="relative md:py-72">
          {/* Line */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            {TIMELINE_DATA.map((item, index) => (
              ...
              >
                ...
                <div className={`p-6 glass-panel md:absolute w-full md:w-48 lg:w-64 transition-all duration-300 hover:border-brand-gold ${index % 2 === 0 ? 'md:bottom-full md:mb-12' : 'md:top-full md:mt-12'} left-1/2 md:-translate-x-1/2`}>
